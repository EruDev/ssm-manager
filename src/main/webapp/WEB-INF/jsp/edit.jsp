        ...
        <div class="row">
            <form class="form-horizontal" role="form" id="userForm" method="post">
                <div class="input-group form-box">
                    <label>客户编号：</label>
                    <input type="text" class="form-control" id="userId" value="${user.id}" disabled="disabled">
                </div>
                <div class="input-group form-box">
                    <label>客户名字：</label>
                ...
                <div class="input-group form-box">
                    <label>客户备注：</label>
                    <input type="text" class="form-control" id="remark" value="${user.remark}">
                </div>
    ...
    <script type="text/javascript">
        $(function () {
            $("#submit").click(function () {
                ...
                console.log(json);
                $.ajax({
                    url: "<%=request.getContextPath()%>/toEdit",
                    type: "POST",
